...
module.exports = function (RED) {
    function VerifyNode(config) {
        ...
        node.on('input', function (msg, send, done) {
            ...
            const signature = resolveValue(msg, this.fieldTypesignature, globalContext, flowContext, this.signature);
            ...
            try {
                ...
                if (slots.length > 0) {
                    ...
                    if (slot.flags & graphene.SlotFlag.TOKEN_PRESENT) {
                        ...
                        const publicKey = session.find({label: publicKeyLabel, class: graphene.ObjectClass.PUBLIC_KEY});
